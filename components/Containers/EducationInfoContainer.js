...
function EducationInfoContainer({setValues}) {
    ...
    const hoverColumns = (event) => {
        switch (event.target.id) {
            case "EducGrid1":
                document.getElementById("EducGrid1").setAttribute("src", "/images/grid1Hover.svg");
                break;
            case "EducGrid2":
                document.getElementById("EducGrid2").setAttribute("src", "/images/grid2Hover.svg");
                break;
            case "EducGrid3":
                document.getElementById("EducGrid3").setAttribute("src", "/images/grid3Hover.svg");
                break;
    ...
    const unHoverColumns = (event) => {
        switch (event.target.id) {
            case "EducGrid1":
                document.getElementById("EducGrid1").setAttribute("src", "/images/grid1.svg");
                break;
            case "EducGrid2":
                document.getElementById("EducGrid2").setAttribute("src", "/images/grid2.svg");
                break;
            case "EducGrid3":
                document.getElementById("EducGrid3").setAttribute("src", "/images/grid3.svg");
                break;
